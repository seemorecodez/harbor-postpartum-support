...
The React Native ZIP remains **prototype source**. The committed Flutter tree and current integrity-audited web/source downloads are alpha.18. They remain **engineering alpha**, not a “complete app” or release candidate; no native release artifact is implied by the presence of native target source.
