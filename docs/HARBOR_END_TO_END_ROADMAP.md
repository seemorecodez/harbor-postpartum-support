...
The React Native ZIP remains **prototype source**. The committed Flutter tree and current integrity-audited web/source downloads are alpha.25. All remain **engineering alpha**, not a “complete app” or release candidate; a hosted compile artifact is not an installed or signed native release.
