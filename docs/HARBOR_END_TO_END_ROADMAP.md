...
The React Native ZIP remains **prototype source**. The current Flutter worktree, public deployment, and latest reconciled canonical downloads are alpha.28 at tested feature commit `55ad236`. All remain **engineering alpha**, not a “complete app” or release candidate; a public static deployment or hosted compile artifact is not an installed, clinically approved, or signed native release.
