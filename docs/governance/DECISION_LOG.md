...
- **Remaining gate:** Pass alpha.27 public CI/deployment and repeat live-origin framing/offline checks; document hosting retention limits; establish monitoring/rollback; and move any production claim to a host that can enforce `frame-ancestors`, nosniff, and the accepted response-header policy.
