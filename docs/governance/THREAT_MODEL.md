...
**Scope:** Harbor alpha 23 private vault, passphrase-wrapped local app lock, typed reviewed clipboard boundary, bounded diagnostics, and offline web/PWA boundary. This is an engineering threat model, not an independent security assessment or security guarantee.
