...
void main() {
  ...
  setUp(() async {
    ...
    final files = <String, List<int>>{
      ...
      'flutter_bootstrap.js': 'const HARBOR_RELEASE="alpha.25";'.codeUnits,
      ...
      'version.json': '{"version":"0.1.0-alpha.25"}'.codeUnits,
  ...
  test(
    ...
    () async {
      ...
      expect(worker, contains('./flutter_bootstrap.js?v=0.1.0-alpha.25'));
